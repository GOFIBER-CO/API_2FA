...
async function createVersionOfOperating(req, res) {
  ...
  try {
    ...
    req.body.operating = "63b684758e801bc786164bd1";
...
async function updateVersionOfOperating(req, res) {
  ...
  try {
    const data = {
      ...
      operating: req.operating || "63b684788e801bc786164bd3",
      ...req.body,
    };
...
async function getPagingVersionOfOperating(req, res) {
  ...
  let searchByLabel = req.query.label || "";
  let searchByOperating = req.query.operating || "";
  const searchObj = {};
  if (searchByLabel) {
